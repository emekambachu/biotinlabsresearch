        ...
        <div id="rev_slider_5_1" class="rev_slider fullwidthabanner" data-version="5.4.8">
            <ul>
                ...
                <li data-index="rs-7" data-transition="slotzoom-horizontal" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="1500" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <!-- LAYER NR. 6 -->
                    <a class="tp-caption ttm_prettyphoto" href="" target="_self" id="slide-7-layer-6" data-x="['left','left','left','left']" data-hoffset="['319','319','278','278']" data-y="['bottom','bottom','bottom','bottom']" data-voffset="['192','192','102','80']"
                       ...
                       data-paddingright="[0,0,0,0]"
                       data-paddingbottom="[0,0,0,0]"
                       data-paddingleft="[0,0,0,0]">View Video</a>
            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="row align-items-center no-gutters">
                                    ...
                                    <div class="mt_5 pb-30">
                                        ...
                                        <ul class="ttm-list ttm-list-style-icon">
                                            <li><i class="fa fa-minus"></i>
                                                <div class="ttm-list-li-content">Analytical Balances and Proper Weighing Practices</div></li>
                                            <li><i class="fa fa-minus"></i>
                                                <div class="ttm-list-li-content">Solutions for Cannabis Sample Preparation and Analysis</div></li>
                                            <li><i class="fa fa-minus"></i>
                                                <div class="ttm-list-li-content">Three Steps to Better Reproducibility in Research Labs</div></li>
                                            <li><i class="fa fa-minus"></i>
                                                <div class="ttm-list-li-content">Analytical Balances and Proper Weighing Practices</div></li>
                                        </ul>
                                ...
                                <div class="col-xl-7 col-lg-6">
                                    ...
                                    <div class="ttm_single_image-wrapper text-right pb-30">
                                        <img class="img-fluid" src="{{ asset('images/single-img-four.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-center no-gutters">
                                <div class="col-xl-7 col-lg-6">
                                    ...
                                    <div class="ttm_single_image-wrapper">
                                        <img class="img-fluid" src="{{ asset('images/single-img-five.jpg') }}" alt="">
                                    </div>
                                </div>
                                <div class="col-xl-5 col-lg-6">
                    ...
                    <div class="col-md-12 text-center mt-4">
                        <a href="{{ url('services') }}">
                            <button class="submit ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor" type="submit">Our Services</button>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-10 m-auto">
                        ...
                        <div class="section-title with-sep title-style-center_text">
                            <div class="title-header">
                                <h5>Gallery</h5>
                                <h2 class="title">Inside our labs</h2>
                            </div>
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 cardiology anestheslology">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio ttm-portfolio-box-view1">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                ...
                                                <a href="#">
                                                    <img class="img-fluid" src="{{ asset('images/portfolio/01.jpg') }}"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Rehabilitation Center"
                                                       data-rel="prettyPhoto" href="{{ asset('images/portfolio/04.jpg') }}">
                                                ...
                                                <div class="ttm-box-view-content-inner">
                                                    <div class="featured-content featured-content-portfolio">
                                                        <div class="featured-title">
                                                            <h5><a href="">Rehabilitation Center</a></h5>
                                                        </div>
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 pediatric orthopedics">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio ttm-portfolio-box-view1">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="">
                                                        <img class="img-fluid" src="{{ asset('images/portfolio/02.jpg') }}"
                                                             alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Diagnostic Imagine"
                                                       data-rel="prettyPhoto" href="{{ asset('images/portfolio/02.jpg') }}">
                                                        <i class="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                                <div class="ttm-box-view-content-inner">
                                                    <div class="featured-content featured-content-portfolio">
                                                        <div class="featured-title">
                                                            <h5><a href="">Diagnostic Imagine</a></h5>
                                                        </div>
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 pharmacy pediatric orthopedics">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio ttm-portfolio-box-view1">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                <!-- featured-thumbnail -->
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid" src="{{ asset('images/portfolio/03.jpg') }}" alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Orthodontics Surgery"
                                                       data-rel="prettyPhoto" href="{{ asset('images/portfolio/03.jpg') }}">
                                                        <i class="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                                <div class="ttm-box-view-content-inner">
                                                    <div class="featured-content featured-content-portfolio">
                                                        <div class="featured-title">
                                                            <h5><a href="">Orthodontics Surgery</a></h5>
                                                        </div>
                                                        <span class="category">Orthopedics, Pediatric</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 cardiology anestheslology">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio ttm-portfolio-box-view1">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{ asset('images/portfolio/04.jpg') }}"
                                                             alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Rehabilitation Center"
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 pharmacy pediatric orthopedics">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio ttm-portfolio-box-view1">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{ asset('images/portfolio/05.jpg') }}"
                                                             alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Blood Pressure Checkup"
                                                       data-rel="prettyPhoto" href="{{ asset('images/portfolio/05.jpg') }}">
                                                        <i class="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                                <div class="ttm-box-view-content-inner">
                                                    <div class="featured-content featured-content-portfolio">
                                                        <div class="featured-title">
                                                            <h5><a href="">Blood Pressure Checkup</a></h5>
                                                        </div>
                                    ...
                                    <div class="ttm-box-col-wrapper col-lg-4 col-md-4 col-sm-6 cardiology anestheslology">
                                        ...
                                        <div class="featured-imagebox featured-imagebox-portfolio ttm-portfolio-box-view1">
                                            ...
                                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay"><!-- featured-thumbnail -->
                                                <div class="featured-thumbnail">
                                                    <a href="#">
                                                        <img class="img-fluid" src="{{ asset('images/portfolio/06.jpg') }}"
                                                             alt="image"></a>
                                                </div><!-- featured-thumbnail end -->
                                                <div class="featured-iconbox ttm-media-link">
                                                    <a class="ttm_prettyphoto ttm_image" title="Dentures / Partial Dentures"
                                                       data-rel="prettyPhoto" href="{{ asset('images/portfolio/06.jpg') }}">
                                                        <i class="fa fa-expand"></i>
                                                    </a>
                                                </div>
                                                <div class="ttm-box-view-content-inner">
                                                    <div class="featured-content featured-content-portfolio">
                                                        <div class="featured-title">
                                                            <h5><a href="">Dentures / Partial Dentures</a></h5>
                                                        </div>
                                                        <span class="category">Cardiology, Anestheslology</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="slick_slider" data-slick='{"slidesToShow": 6, "slidesToScroll": 1, "arrows":false, "autoplay":false, "infinite":true}'>
                                        ...
                                        <div class="ttm-client-logo-tooltip" data-tooltip="client-01">
                                            <div class="ttm-client-logo-tooltip-inner">
                                                <div class="client-thumbnail">
                                                    <img class="img-fluid" src="{{ asset('images/client/client-01.png') }}"
                                                         alt="image">
                                                </div>
                                                <div class="client-thumbnail_hover">
                                                    <img src="{{ asset('images/client/hover-client-01.png') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="client-box">
                                        <div class="ttm-client-logo-tooltip" data-tooltip="client-02">
                                            <div class="ttm-client-logo-tooltip-inner">
                                                <div class="client-thumbnail">
                                                    <img class="img-fluid" src="{{ asset('images/client/client-02.png') }}"
                                                         alt="image">
                                                </div>
                                                <div class="client-thumbnail_hover">
                                                    <img src="{{ asset('images/client/hover-client-02.png') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="client-box">
                                        <div class="ttm-client-logo-tooltip" data-tooltip="client-03">
                                            <div class="ttm-client-logo-tooltip-inner">
                                                <div class="client-thumbnail">
                                                    <img class="img-fluid" src="{{ asset('images/client/client-03.png') }}"
                                                         alt="image">
                                                </div>
                                                <div class="client-thumbnail_hover">
                                                    <img src="{{ asset('images/client/hover-client-03.png') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="client-box">
                                        <div class="ttm-client-logo-tooltip" data-tooltip="client-04">
                                            <div class="ttm-client-logo-tooltip-inner">
                                                <div class="client-thumbnail">
                                                    <img class="img-fluid" src="{{ asset('images/client/client-04.png') }}"
                                                         alt="image">
                                                </div>
                                                <div class="client-thumbnail_hover">
                                                    <img src="{{ asset('images/client/hover-client-04.png') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="client-box">
                                        <div class="ttm-client-logo-tooltip" data-tooltip="client-05">
                                            <div class="ttm-client-logo-tooltip-inner">
                                                <div class="client-thumbnail">
                                                    <img class="img-fluid" src="{{ asset('images/client/client-05.png') }}" alt="image">
                                                </div>
                                                <div class="client-thumbnail_hover">
                                                    <img src="{{ asset('images/client/hover-client-05.png') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="client-box">
                                        <div class="ttm-client-logo-tooltip" data-tooltip="client-06">
                                            <div class="ttm-client-logo-tooltip-inner">
                                                <div class="client-thumbnail">
                                                    <img class="img-fluid" src="{{ asset('images/client/client-06.png') }}" alt="image">
                                                </div>
                                                <div class="client-thumbnail_hover">
                                                    <img src="{{ asset('images/client/hover-client-06.png') }}" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
